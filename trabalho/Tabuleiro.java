    ...
    public class Tabuleiro extends JPanel {
       ...
       private Image casa; 
        ...
        public void inicializaCasas() {
            ...
            casasTabuleiro[1] = new CasaTabuleiro(170, 0, TAM_CASA, TAM_CASA, 800, 75, 2, "Rua das Cadeiras", banco, "./Tabuleiro/2.png");
            ...
            casasTabuleiro[4] = new CasaTabuleiro(680, 0, TAM_CASA, TAM_CASA, 1000, 120, 19, "Rua dos Toilets", banco, "./Tabuleiro/19.png"); //19->5
            
            casa = new ImageIcon("./Tabuleiro/20.png").getImage();
            casasTabuleiro[5] = new CasaTabuleiro(850, 0, TAM_CASA, TAM_CASA, 950, 110, 20, "Rua dos Closets", banco, "./Tabuleiro/20.png"); //20->6
            
            casa = new ImageIcon("./Tabuleiro/5.png").getImage();
            casasTabuleiro[6] = new CasaTabuleiro(1020, 0, TAM_CASA, TAM_CASA, 0, 100, 5, "Absolute Imposto", banco, "./Tabuleiro/5.png") ; //5->7
            
            //casas da direita
            casa = new ImageIcon("./Tabuleiro/8.png").getImage();
            casasTabuleiro[7] = new CasaTabuleiro(1020, 170, TAM_CASA, TAM_CASA, 750, 80, 8, "Caminho do Sofá", banco, "./Tabuleiro/8.png");
            ...
            casasTabuleiro[11] = new CasaTabuleiro(1020, 850, TAM_CASA, TAM_CASA, 0, 0, 7, "Férias", banco, "./Tabuleiro/7.png");  //7->12
            
            //casas de baixo
            casa = new ImageIcon("./Tabuleiro/14.png").getImage();
            casasTabuleiro[12] = new CasaTabuleiro(850, 850, TAM_CASA, TAM_CASA, 1050, 200, 14, "Caminho da Geladeira", banco, "./Tabuleiro/14.png");
            ...
            casasTabuleiro[16] = new CasaTabuleiro(170, 850, TAM_CASA, TAM_CASA, 1100, 200, 17, "Mesa Gamer", banco, "./Tabuleiro/17.png");
            
            casa = new ImageIcon("./Tabuleiro/10.png").getImage();
            casasTabuleiro[17] = new CasaTabuleiro(0, 850, TAM_CASA, TAM_CASA, 0, 0, 10, "Prisão", banco, "./Tabuleiro/10.png");
         
            //casas da esquerda
            casa = new ImageIcon("./Tabuleiro/11.png").getImage();
            casasTabuleiro[18] = new CasaTabuleiro(0, 680, TAM_CASA, TAM_CASA, 750, 80, 11, "Caminho da Cama", banco, "./Tabuleiro/11.png");
            
            casa = new ImageIcon("./Tabuleiro/12.png").getImage();
            casasTabuleiro[19] = new CasaTabuleiro(0, 510, TAM_CASA, TAM_CASA, 600, 70, 12, "Rua dos Puffs", banco, "./Tabuleiro/12.png");
